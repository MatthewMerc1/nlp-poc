...
if [ ! -f "scripts/upload_gutenberg.py" ]; then
    echo "Error: scripts/upload_gutenberg.py not found"
    exit 1
fi
...
python scripts/upload_gutenberg.py --bucket "$BUCKET_NAME" --profile "caylent-dev-test" --limit 10
