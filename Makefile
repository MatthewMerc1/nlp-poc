...
status:
	...
	@echo "  Terraform state: $(shell [ -f "infrastructure/terraform/environments/dev/.terraform/terraform.tfstate" ] && echo "✓ Deployed" || echo "✗ Not deployed")"
	@echo "  Lambda package: $(shell [ -f "infrastructure/terraform/environments/dev/.terraform/lambda_function.zip" ] && echo "✓ Packaged" || echo "✗ Not packaged")" 